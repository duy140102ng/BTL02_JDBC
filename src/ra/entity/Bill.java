...
public class Bill {
    ...
    public Bill(long billId, String billCode, boolean billType, String empIdCreated, Date created, String empIdAuth, Date authDate, int quantity, float price, long billDetailId, String productId, int billStatus) {
        this.billId = billId;
    ...
    public void displayDataBrowse() {
        System.out.printf("Mã phiếu: %d - Mã code: %s - Loại phiếu: %s\n", this.billId, this.billCode, (this.billType == true ? "Phiếu nhập" : "Phiếu xuất"));
        System.out.printf("Mã nhân viên duyệt: %s - Ngày duyệt: %s - Số lượng xuất: %d - Gía xuất: %f\n", this.empIdAuth, this.authDate, this.quantity, this.price);
        System.out.printf("Mã sản phẩm: %s - Trạng thái: %s\n",this.productId, (this.billStatus == 0 ? "Tạo" : (this.billStatus == 1 ? "Hủy" : "Duyệt")));
    }

    public void displayDataBillDetail() {
        System.out.printf("Mã phiếu chi tiết: %d - Mã phiếu xuất: %d - Mã sản phẩm: %s\n", this.billDetailId, this.billId, this.productId);
        System.out.printf("Số lượng xuất: %d - Gía xuất: %f\n", this.quantity, this.price);
    }
}
